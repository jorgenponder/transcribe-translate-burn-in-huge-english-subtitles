...
It seems like the color spec is in RGB but backwards, that is BGR format. ```&H6699ff``` seems to give a nice orange color.

Setting the outline color to white, i.e. ```&Hffffff``` seems to helt the text pop a bit too.
...
Here's an example:
    ...
    Style: Default,DejaVu Sans Bold,48,&H6699ff,&H000000,&Hffffff,&H000000,0,0,0,0,100,100,0,0,1,1,0,2,10,10,10,0
